...
public class MBAuthenticationFailureHandler implements AuthenticationFailureHandler {
	...
	public void onAuthenticationFailure(HttpServletRequest request, HttpServletResponse response, AuthenticationException exception) throws IOException, ServletException 
	{
		...
		if(username.equals("") || password.equals(""))
		{
			if(username.equals("")  && password.equals("") )
			{
				request.getSession().setAttribute("error", "Harap mengisi username dan password!");
			}
			else if(username.equals(""))
			{
				request.getSession().setAttribute("error", "Harap mengisi username!");
			}
			else
			{
				request.getSession().setAttribute("error", "Harap mengisi password!");
			}
		}
		else
		{
